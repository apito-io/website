...
Database design/modeling is the most **crucial part of your project**. In this article there will be a brief introduction about when and when not to create a data model, and appreciate fundamental data design techniques.
...
![Apito Console - Model](https://cdn.apito.io/media/apito_documentation/XL8YIXTZO1_Apito_Console___Model.png)
