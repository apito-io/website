...
title: How to build API | Quick Start Guide
sidebar_label: Introduction
---

Apito is a Cloud based Backend-as-a-Service which helps you build API easily. You can think of it as a firebase alternative.
...
Once you logged in to `Apito Console` you will a Project Space like above. You can use this space to switch between your projects or create a new one.
